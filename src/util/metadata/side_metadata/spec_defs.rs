...
define_side_metadata_specs!(
    ...
    COMPRESSOR_OFFSET_VECTOR = (global: false, log_num_of_bits: crate::policy::compressor::forwarding::LOG_BITS_IN_ENCODED, log_bytes_in_region: crate::policy::compressor::forwarding::Block::LOG_BYTES),
